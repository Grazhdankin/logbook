...
public final class Paths {
    ...
    public static final String PASSAGE_LOGS_API_PATH = "/passage-logs";
    public static final String COMMON_LOGS_API_PATH = "/common-logs";
    public static final String GENERAL_LOGS_API_PATH = "/general-logs";
